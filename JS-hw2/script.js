...
console.log((num1 <= 1) ? 'num1 <= 1' : 'num1 > 1');
console.log((num2 >= 3) ? 'num2 >= 3' : 'num2 < 3');
...
else if (day <= 31 && day > 20) { console.log('Third decade'); }
...
let ed = num % 10
let des = (num - ed) % 100
let sot = (num - ed - des) % 1000
console.log(`В числе ${num} количество сотен: ${sot / 100}, десятков: ${des / 10}, единиц: ${ed}`);
